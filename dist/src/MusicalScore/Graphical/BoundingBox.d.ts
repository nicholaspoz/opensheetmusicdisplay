...
export declare class BoundingBox {
    ...
    readonly RelativePositionHasBeenSet: boolean;
    XBordersHaveBeenSet: boolean;
    YBordersHaveBeenSet: boolean;
    AbsolutePosition: PointF2D;
    RelativePosition: PointF2D;
    Size: SizeF2D;
    readonly MarginSize: SizeF2D;
    readonly UpperLeftCorner: PointF2D;
    readonly UpperLeftMarginCorner: PointF2D;
    BorderLeft: number;
    BorderRight: number;
    BorderTop: number;
    BorderBottom: number;
    ...
    readonly BoundingRectangle: RectangleF2D;
    readonly BoundingMarginRectangle: RectangleF2D;
    ChildElements: BoundingBox[];
    Parent: BoundingBox;
    readonly DataObject: Object;
