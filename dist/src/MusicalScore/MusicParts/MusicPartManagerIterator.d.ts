...
export declare class MusicPartManagerIterator {
    ...
    readonly FrontReached: boolean;
    readonly CurrentMeasure: SourceMeasure;
    readonly CurrentRepetition: Repetition;
    readonly CurrentRepetitionIteration: number;
    readonly CurrentJumpResponsibleRepetitionIterationBeforeJump: number;
    readonly CurrentVoiceEntries: VoiceEntry[];
    readonly CurrentMeasureIndex: number;
    readonly CurrentEnrolledTimestamp: Fraction;
    readonly CurrentSourceTimestamp: Fraction;
    readonly JumpOccurred: boolean;
    readonly ActiveTempoExpression: MultiTempoExpression;
    readonly ActiveDynamicExpressions: AbstractExpression[];
    readonly CurrentTempoChangingExpression: MultiTempoExpression;
    readonly JumpResponsibleRepetition: Repetition;
