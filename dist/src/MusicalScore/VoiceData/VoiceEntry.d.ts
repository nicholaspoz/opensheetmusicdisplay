...
export declare class VoiceEntry {
    ...
    readonly ParentSourceStaffEntry: SourceStaffEntry;
    readonly ParentVoice: Voice;
    Timestamp: Fraction;
    readonly Notes: Note[];
    readonly Articulations: ArticulationEnum[];
    readonly TechnicalInstructions: TechnicalInstruction[];
    readonly LyricsEntries: Dictionary<number, LyricsEntry>;
